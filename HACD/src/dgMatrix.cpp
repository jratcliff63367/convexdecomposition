...
{
	int32_t dstStride = dstStrideInBytes /sizeof (float);
	int32_t srcStride = srcStrideInBytes / sizeof (float);
...
{
	int32_t dstStride = dstStrideInBytes /sizeof (double);
	int32_t srcStride = srcStrideInBytes / sizeof (double);
